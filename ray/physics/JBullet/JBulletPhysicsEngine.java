...
import ray.physics.PhysicsHingeConstraint;
import ray.physics.PhysicsObject;
import ray.physics.JBullet.JBulletBallSocketConstraint;
import ray.physics.JBullet.JBulletBoxObject;
import ray.physics.JBullet.JBulletCapsuleObject;
import ray.physics.JBullet.JBulletCapsuleXObject;
import ray.physics.JBullet.JBulletCapsuleZObject;
import ray.physics.JBullet.JBulletConeObject;
import ray.physics.JBullet.JBulletConeXObject;
import ray.physics.JBullet.JBulletConeZObject;
import ray.physics.JBullet.JBulletCylinderObject;
import ray.physics.JBullet.JBulletCylinderXObject;
import ray.physics.JBullet.JBulletCylinderZObject;
import ray.physics.JBullet.JBulletHingeConstraint;
import ray.physics.JBullet.JBulletPhysicsEngine;
import ray.physics.JBullet.JBulletPhysicsObject;
import ray.physics.JBullet.JBulletSphereObject;
import ray.physics.JBullet.JBulletStaticPlaneObject;

/**
 * This class provides an implementation of the {@link IPhysicsEngine} interface using the
 * {@link <A href="http://jbullet.advel.cz/">JBullet</a>} physics engine.
 * 
...
public class JBulletPhysicsEngine implements PhysicsEngine {
	// maximum number of objects (and allow user to shoot additional boxes)
		...
		static
		{
			PhysicsEngineFactory.registerPhysicsEngine("ray.physics.JBullet.JBulletPhysicsEngine", JBulletPhysicsEngine.class);
		}
		 ...
		 * <I>does not use the DEFAULT_GRAVITY constants defined in {@link IPhysicsEngine}</i>.
		 */
		public void initSystem() {
			...
			// {IPhysicsEngine.DEFAULT_GRAVITY_X,IPhysicsEngine.DEFAULT_GRAVITY_Y,IPhysicsEngine.DEFAULT_GRAVITY_Z};
		...
		*/
		...
		public PhysicsObject addBoxObject(int uid, float mass, double[] transform, float[] size) {
			// IPhysicsEngine asks for dimensions, JBullet uses halfExtents
