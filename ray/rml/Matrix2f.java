...
import ray.rml.Bufferable;
import ray.rml.FloatUtil;
import ray.rml.MathUtil;
import ray.rml.Matrix2;
import ray.rml.Matrix2f;
import ray.rml.MatrixUtil;
import ray.rml.Vector2;
import ray.rml.Vector2f;

/**
 * An immutable single-precision floating point column-major 2x2 square
 * {@link Matrix2 matrix}.
 * <p>
...
public final class Matrix2f implements Matrix2 {
    ...
    /**
     * Creates a new identity {@link Matrix2 matrix}.
     * <p>
    ...
    /**
     * Creates a new {@link Matrix2 matrix} from the specified values.
     *
     * @param values
     *            An array of at least 4 values, in column-major order.
     * @return A new {@link Matrix2 matrix} from the specified values.
    ...
    /**
     * Creates a new {@link Matrix2 matrix} from the specified column vectors.
     *
     * @param c0
     *            A {@link Vector2} with values for the first column.
     * @param c1
     *            A {@link Vector2} with values for the second column.
     * @return A new {@link Matrix2 matrix} from the specified values.
     */
     ...
     * @param values
     *            An array of at least 4 values, in column-major order.
     * @return A new inverse {@link Matrix2 matrix} calculated from the specified
     *         values.
    ...
    /**
     * Creates a new transposed {@link Matrix2 matrix} from the specified values.
     *
     * @param data
     *            An array of at least 4 values, in column-major order.
     * @return A new transposed {@link Matrix2 matrix} calculated from the specified
     *         values.
     * @throws IndexOutOfBoundsException
    ...
    /**
     * Creates a new {@link Matrix2 matrix} from the specified scaling values.
     *
     * @param sx
     ...
     * @return A new {@link Matrix2 matrix} that can be used to scale another
     *         {@link Matrix2 matrix} when multiplied together.
     */
     ...
     *
     * @param sv
     *            A {@link Vector2} with scaling values for the x and y components.
     * @return A new {@link Matrix2 matrix} that can be used to scale another
     *         {@link Matrix2 matrix} when multiplied together.
     */
