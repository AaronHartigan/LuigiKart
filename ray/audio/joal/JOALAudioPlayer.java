...
public class JOALAudioPlayer extends AudioPlayer
{
	 ...
	 */
	public void setEmitDirection(Vector3 direction, float coneAngle)
	{
	...
	/**
	 * Returns the location of this {@link JOALAudioPlayer} as a {@link Vector3}.  
	 */
	public Vector3 getLocation() 
	{
		...
		location = Vector3f.createFrom(vLocation[0], vLocation[1], vLocation[2]);
		
		return location;
	}

	/**
	 * Returns the velocity of this {@link JOALAudioPlayer} as a {@link Vector3}. 
	 */
	public Vector3 getVelocity() 
	{
		...
		velocity = Vector3f.createFrom(vVelocity[0], vVelocity[1], vVelocity[2]);
	 ...
	 * 
	 * @param rollOff Values > 1 make the sound get quieter much quicker the further the ear gets from the source.  For a value = 0 distance attenuation is disabled. Range: [0, any]
	 * 
	 * @see <a href="http://www.openal.org/documentation/openal-1.1-specification.pdf">OpenAL Specification</a>
	 */
