...
public class JOALAudioEar extends AudioEar 
{
	...
	/**
	 * Returns the Listener AL_POSITION value as a {@link Point3D}.
	 */
	public Vector3 getLocation() 
	{
		...
		Vector3 location = Vector3f.createFrom(vLocation[0], vLocation[1], vLocation[2]);
		
		return location;
	}

	/**
	 * Returns the Listener AL_VELOCITY value as a {@link Vector3D}.
	 */
