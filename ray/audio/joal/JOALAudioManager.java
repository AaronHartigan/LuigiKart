...
public class JOALAudioManager extends AudioManager 
{
	...
	public boolean initialize() 
	{
		...
		audioEar.setLocation(Vector3f.createZeroVector());
		audioEar.setVelocity(Vector3f.createZeroVector());
		audioEar.setOrientation(Vector3f.createFrom(0.0f, 0.0f, -1.0f), Vector3f.createUnitVectorY());
