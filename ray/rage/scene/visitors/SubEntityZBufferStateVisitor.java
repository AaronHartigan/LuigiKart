...
import ray.rage.scene.visitors.SubEntityZBufferStateVisitor;
 ...
 *
 */
public final class SubEntityZBufferStateVisitor implements SubEntity.Visitor {

    private final SceneManager manager;

    /**
     * Creates a new {@link SubEntityZBufferStateVisitor}.
     *
     * @param sm
     ...
     */
    public SubEntityZBufferStateVisitor(SceneManager sm) {
        if (sm == null)
    ...
    public void visit(SubEntity subEntity) {
        ...
        RenderState state = system.createRenderState(RenderState.Type.ZBUFFER);
