...
// TODO import rage.input. action stuff
...
public class ComponentStateInfo {
	// the most recent Event associated with the component
		...
		//This flag allows determining whether to repeat events 
		...
		private InputManager.INPUT_ACTION_TYPE actionType;
		 ...
		 * 					invoked)  
		 */
		public ComponentStateInfo(boolean pressed, 
